...
namespace Tetrics
{
    class LSprite:Sprite
    {
        public LSprite()
            :base()
        {
            tiles[0,0] = 1; tiles[0,1] = 1; tiles[0,2] = 0; tiles[0,3] = 0;
        ...
        public override void Rotate()
        {
            if (Status == 2)
            {
                ...
                tiles[2,0] = 1; tiles[2,1] = 0; tiles[2,2] = 0; tiles[2,3] = 0;
                tiles[3,0] = 0; tiles[3,1] = 0; tiles[3,2] = 0; tiles[3,3] = 0;
            }
            else if (Status == 1)
            {
                ...
                tiles[1,0] = 0; tiles[1,1] = 1; tiles[1,2] = 0; tiles[1,3] = 0;
                tiles[2,0] = 0; tiles[2,1] = 1; tiles[2,2] = 1; tiles[2,3] = 0;
                tiles[3,0] = 0; tiles[3,1] = 0; tiles[3,2] = 0; tiles[3,3] = 0;
            }
            else if (Status == 0)
            {
                Status = 1;
                tiles[0,0] = 0; tiles[0,1] = 0; tiles[0,2] = 1; tiles[0,3] = 0;
                tiles[1,0] = 1; tiles[1,1] = 1; tiles[1,2] = 1; tiles[1,3] = 0;
